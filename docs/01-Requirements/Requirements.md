...
The following sections document the requirements that the this module needs to fulfills to have the required sensore capabilities on the Subtterianian Rover. 

The table below shows the minimum acceptable performance levels, target values, and stretch‑goal indicators for the sensor capabilities of the subtteranian rover. 
